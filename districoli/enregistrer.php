...
//création colis puis mise à jour du solde_colis du bénéficiaire
...
$sql=$sql." values (\"".
		...
		\"".$_POST['sem3']."\",
		\"".$_POST['sem4']."\",
		".$_POST['solde_colis'] ." - ". $_POST['montantcolis']." + ". $_POST['montantpaye'].",
...
$sql2="update districolis_historique
